        ...
        <div class="modal-content">
                ...
                <div class="em_profile_user">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="txt">
                                <h3>Jason Hamilton</h3>
                                <p>belinda.miller@gmail.com</p>
            ...
            <div class="modal-body">
                <ul class="nav flex-column -active-links">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="page-offers.html">
                            <div class="">
                                <div class="icon_current">
                                    <svg id="Iconly_Two-tone_Discount" data-name="Iconly/Two-tone/Discount"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24">
                                        <g id="Discount" transform="translate(2 2)">
                                            <path id="Stroke_1" data-name="Stroke 1"
                                                ...
                                                transform="translate(0.75 0.751)" fill="none" stroke="#200e32"
                                                stroke-linecap="round" stroke-linejoin="round"
                                                stroke-miterlimit="10" stroke-width="1.5" />
                                            <path id="Stroke_3" data-name="Stroke 3" d="M0,5.14,5.14,0"
                                                transform="translate(7.43 7.43)" fill="none" stroke="#200e32"
                                                stroke-linecap="round" stroke-linejoin="round"
                                                stroke-miterlimit="10" stroke-width="1.5" opacity="0.4" />
                                            <path id="Fill_5" data-name="Fill 5"
                                                ...
                                                transform="translate(11.817 11.832)" fill="#200e32"
                                                opacity="0.4" />
                                            <path id="Fill_7" data-name="Fill 7"
                                                ...
                                                transform="translate(6.677 6.692)" fill="#200e32"
                                                opacity="0.4" />
                                        </g>
                                    </svg>
                                </div>
                                <div class="icon_active">
                                    <svg id="Iconly_Bulk_Discount" data-name="Iconly/Bulk/Discount"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24">
                                        <path id="Fill_1" data-name="Fill 1"
                                            ...
                                            transform="translate(2 2)" fill="#200e32" opacity="0.4" />
                                        <path id="Combined_Shape" data-name="Combined Shape"
                                            ...
                                            transform="translate(8.552 8.554)" fill="#200e32" />
                                    </svg>
                                </div>
                                <span class="title_link">Offers</span>
                            </div>

                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="page-default-basket.html">
                            <div class="">
                                <div class="icon_current">
                                ...
                                <span class="title_link">Basket</span>
                            </div>
                            <div class="em_pulp">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="page-contact.html">
                            <div class="">
                                ...
                                <div class="icon_active">
                                    <svg id="Iconly_Bulk_Message" data-name="Iconly/Bulk/Message"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24">
                                        <path id="Fill_1" data-name="Fill 1"
                                            ...
                                            transform="translate(2 8.797)" fill="#200e32" opacity="0.4" />
                                        <path id="Fill_4" data-name="Fill 4"
                                            ...
                                            transform="translate(2.503 3)" fill="#200e32" />
                                    </svg>
                                </div>
                                <span class="title_link">Contact</span>
                            </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="page-about.html">
                            <div class="">
                                <div class="icon_current">
                                    <svg id="Iconly_Two-tone_Info_Square"
                                        data-name="Iconly/Two-tone/Info Square"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24">
                                        <g id="Info_Square" data-name="Info Square" transform="translate(2 2)">
                                            <path id="Stroke_1" data-name="Stroke 1" d="M.5,4.419V0"
                                                transform="translate(9.49 9.377)" fill="none" stroke="#200e32"
                                                stroke-linecap="round" stroke-linejoin="round"
                                                stroke-miterlimit="10" stroke-width="1.5" opacity="0.4" />
                                            <path id="Stroke_2" data-name="Stroke 2" d="M.5.5H.5"
                                                transform="translate(9.495 5.704)" fill="none" stroke="#200e32"
                                                stroke-linecap="round" stroke-linejoin="round"
                                                stroke-miterlimit="10" stroke-width="1.5" opacity="0.4" />
                                            <path id="Stroke_3" data-name="Stroke 3"
                                ...
                                <div class="icon_active">
                                    <svg id="Iconly_Bulk_Info_Square" data-name="Iconly/Bulk/Info Square"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24">
                                        <path id="Fill_1" data-name="Fill 1"
                                        ...
                                        <path id="Combined_Shape" data-name="Combined Shape"
                                            ...
                                            transform="translate(11.12 7.314)" fill="#200e32" />
                                    </svg>
                                </div>
